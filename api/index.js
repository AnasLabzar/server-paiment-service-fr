...
async function sendSuccessEmail(orderData) {
  ...
  try {
    let htmlContent = fs.readFileSync(path.join(__dirname, '..', 'templates', 'email_success_template.html'), 'utf8'); htmlContent = htmlContent
...
async function sendErrorEmail(errorDetails, attemptData) {
  ...
  try {
    let htmlContent = fs.readFileSync(path.join(__dirname, '..', 'templates', 'email_error_template.html'), 'utf8'); htmlContent = htmlContent
